...
def predict():
    ...
    if request.method == "POST":
        ...
        with open("static/image0.jpg", "rb") as img_file:
                encoded_image = base64.b64encode(img_file.read()).decode("utf-8")
        return render_template("output.html", encoded_image=encoded_image)
    return redirect(url_for('home'))

@app.route("/output")
def output():
    return render_template("output.html", image_path="static/image.jpg")
...
def signup():
    ...
    if not email.endswith("@gmail.com"):
        warning = "Only Gmail accounts are allowed for sign-up"
